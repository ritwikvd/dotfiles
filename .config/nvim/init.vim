...
augroup bin_dotfiles_sync
    ...
    au BufWritePost /usr/local/bin/sw,/usr/local/bin/acp,/usr/local/bin/sacp,/usr/local/bin/mer,/usr/local/bin/db,/usr/local/bin/node_numbered_output,/usr/local/bin/updotfiles,/usr/local/bin/upbin !upbin %
augroup end
