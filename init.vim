...
local mappings = function() 
        ...
        vim.keymap.set("n", "gr", "<cmd>lua require'telescope.builtin'.lsp_references({default = {initial_mode = 'normal'}})<cr>", {buffer=0}) 
        vim.keymap.set("n", "gt", vim.lsp.buf.type_definition, {buffer=0}) 
        vim.keymap.set("n", "<leader>td", "<cmd>lua require'telescope.builtin'.diagnostics({default = {initial_mode = 'normal'}})<cr>", {buffer=0}) 
