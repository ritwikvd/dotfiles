...
augroup prettier
    au!
    au BufWritePost ~/Desktop/personal/pushowl/dashboard/*,~/Desktop/personal/pushowl/lib/* silent! execute "!npx --silent prettier --write --loglevel silent --config ~/.prettierrc %:p" | redraw! 
augroup end
